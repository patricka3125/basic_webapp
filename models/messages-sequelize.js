...
exports.sendMessage = function(from, group_name, message) {
  exports.connectDB('Message')
  .then(SQMessage => SQMessage.create({
    from, group_name, message, timestamp: new Date())
  })
  .then(newmsg => {
    var toEmit = {
      id: newmsg.id,
      from: newmsg.from,
      group_name: newmsg.group_name,
